...
type ClientBenefitRepositoryInterface interface {
	...
	GetAll(activePage, itemsPerPage, clientID, statusID int, search, orderBy string, sortDesc bool) (benefits []entity.BenefitResp, totalItems, totalPages int, err error)
}
