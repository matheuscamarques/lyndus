...
type ClientEmployeeRepositoryInterface interface {
	...
	GetAll(activePage, itemsPerPage, clientID int, search, orderBy string, sortDesc, active bool) ([]entity.Employee, int, int, error)
}
